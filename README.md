...
Second weeks challenge was to start working on my online portfolio. This webpage will showcase all my current work and a way to contact me
Due Date: 12/12/21
...
In order to run this application you need to go to the following link: https://benjamind10.github.io/portfolio/

## Application Demo:

![demo](./assets/images/app_demo.png)

## Instructions on how to clone an app:
